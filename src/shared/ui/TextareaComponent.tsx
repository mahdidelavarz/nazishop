    ...
    <div className="flex flex-col items-start justify-between gap-0.5 text-sm">
      ...
      <div className="relative w-full">
        <textarea
          ...
          rows={rows}
          className={`w-full px-4 py-3 bg-card border border-border rounded-lg text-foreground placeholder:text-neutral-400 focus:ring-2 focus:ring-primary-500 focus:border-primary-500 outline-none transition-all resize-none ${textareaStyle} ${
